...
class BestBusCompany:
    ...
    # delete route -----------------------------------------------------------------------------------------------------
    def delete_from_origin(self, line_num: int):
        inx_i = None
    ...
    def delete_from_destin(self, line_num: int):
        inx_i = None
    ...
    def delete_from_stops(self, line_num: int):
    ...
    def delete_route(self, line_num: int):
        ...
        self.delete_from_origin(line_num)
        self.delete_from_destin(line_num)
        self.delete_from_stops(line_num)
        self._line_num2busroute.pop(line_num)

        return True

    # update line ------------------------------------------------------------------------------------------------------
    def display_information_route_by_line(self, line_num):
        if line_num not in self._line_num2busroute:
            return False

        print(self._line_num2busroute[line_num])

    def update_origin(self, line_num: int, new_origin):
